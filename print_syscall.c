...
void print_accept_syscall(pid_t pid, syscall_arg_u* sysarg)
{
  ...
  if (domain == 2 ) { // PF_INET
    fprintf(stderr,"{sa_family=AF_INET, sin_port=htons(%d), sin_addr=inet_addr(\"%s\")}, ",ntohs(arg->sai.sin_port),inet_ntoa(arg->sai.sin_addr));
  }
...
void print_socket_syscall(pid_t pid, syscall_arg_u* sysarg)
{
  ...
  switch (arg->domain) {
    ...
    case 2: 
      ...
      switch (arg->type) {
        case 1: fprintf(stderr,"SOCK_STREAM, "); break;
        case 2: fprintf(stderr,"SOCK_DGRAM, "); break;
        case 3: fprintf(stderr,"SOCK_RAW, "); break;
        case 4: fprintf(stderr,"SOCK_RDM, "); break;
        case 5: fprintf(stderr,"SOCK_SEQPACKET, "); break;
        case 6: fprintf(stderr,"SOCK_DCCP, "); break;
        case 10: fprintf(stderr,"SOCK_PACKET, "); break;
        default : fprintf(stderr,"TYPE UNKNOWN (%d), ",arg->type); break;
      }
      switch (arg->protocol) {
        case 0: fprintf(stderr,"IPPROTO_IP"); break;
        case 1: fprintf(stderr,"IPPROTO_ICMP"); break;
        case 2: fprintf(stderr,"IPPROTO_IGMP"); break;
        case 3: fprintf(stderr,"IPPROTO_GGP"); break;
        case 6: fprintf(stderr,"IPPROTO_TCP"); break;
        case 17: fprintf(stderr,"IPPROTO_UDP"); break;
        case 132: fprintf(stderr,"IPPROTO_STCP"); break;
        case 255: fprintf(stderr,"IPPROTO_RAW"); break;
        default : fprintf(stderr,"PROTOCOL UNKNOWN (%d)", arg->protocol); break;
      }  
      break;
    case 16 : 
      ...
      switch (arg->protocol) {
        case 0: fprintf(stderr,"NETLINK_ROUTE"); break;
        case 1: fprintf(stderr,"NETLINK_UNUSED"); break;
        case 2: fprintf(stderr,"NETLINK_USERSOCK"); break;
        case 3: fprintf(stderr,"NETLINK_FIREWALL"); break;
        case 4: fprintf(stderr,"NETLINK_INET_DIAG"); break;
        default : fprintf(stderr,"PROTOCOL UNKNOWN (%d)", arg->protocol); break;
      }  
      break;
    default :
      fprintf(stderr,"DOMAIN UNKNOWN (%d), ",arg->domain); break;
  }
  fprintf(stderr,") = %d\n", arg->ret);
}
...
void print_getsockopt_syscall(pid_t pid, syscall_arg_u* sysarg)
{
  ...
  switch (arg->level) {
    case 0:
      ...
      switch (arg->optname) {
        case 1: fprintf(stderr,"IP_TOS, "); break; 
        case 2: fprintf(stderr,"IP_TTL, "); break; 
        case 3: fprintf(stderr,"IP_HDRINCL, "); break; 
        case 4: fprintf(stderr,"IP_OPTIONS, "); break;
        case 6: fprintf(stderr,"IP_RECVOPTS, "); break; 
        default: fprintf(stderr,"OPTION UNKNOWN (%d), ", arg->optname); break; 
      }
      break;
        case 1 :
          fprintf(stderr,"SOL_SOCKET, "); 
          switch (arg->optname) {
            case 1: fprintf(stderr,"SO_DEBUG, "); break;
            case 2: fprintf(stderr,"SO_REUSEADDR, "); break;
            case 3: fprintf(stderr,"SO_TYPE, "); break;
            case 4: fprintf(stderr,"SO_ERROR, "); break;
            case 5: fprintf(stderr,"SO_DONTROUTE, "); break;
            case 6: fprintf(stderr,"SO_BROADCAST, "); break;
            case 7: fprintf(stderr,"SO_SNDBUF, "); break;
            case 8: fprintf(stderr,"SO_RCVBUF, "); break;
            case 9: fprintf(stderr,"SO_SNDBUFFORCE, "); break;
            case 10: fprintf(stderr,"SO_RCVBUFFORCE, "); break;
            case 11: fprintf(stderr,"SO_NO_CHECK, "); break;
            case 12: fprintf(stderr,"SO_PRIORITY, "); break;
            case 13: fprintf(stderr,"SO_LINGER, "); break;
            case 14: fprintf(stderr,"SO_BSDCOMPAT, "); break;
            case 15: fprintf(stderr,"SO_REUSEPORT, "); break;
            default: fprintf(stderr,"OPTION UNKNOWN (%d), ", arg->optname); break; 
          }
          break;
            case 41: fprintf(stderr,"SOL_IPV6, "); break;
            case 58: fprintf(stderr,"SOL_ICMPV6, "); break;
            default: fprintf(stderr,"PROTOCOL UNKNOWN (%d), ",arg->level); break;
  }
...
void print_sendmsg_syscall(pid_t pid, syscall_arg_u* sysarg)
{
  ...
  {
    memcpy(buff, arg->data, arg->len);
    fprintf(stderr,", {msg_namelen=%d, msg_iovlen=%d, \"%s\", msg_controllen=%d, msg_flags=%d}, ",(int)arg->msg.msg_namelen,(int)arg->msg.msg_iovlen,buff, (int)arg->msg.msg_controllen,arg->msg.msg_flags);
  }
  else
  {
