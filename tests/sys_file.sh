...
sudo $debug ../src/simterpose -s multicore_machine.xml sys_file.xml
else
sudo LD_PRELOAD=../src/libsgtime.so  $debug ../src/simterpose -s multicore_machine.xml sys_file.xml
fi
