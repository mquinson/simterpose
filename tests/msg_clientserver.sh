...
sudo $debug ../src/simterpose -s platform.xml msg_clientserver.xml
...
sudo LD_PRELOAD=../src/libsgtime.so $debug ../src/simterpose -s platform.xml msg_clientserver.xml
fi
