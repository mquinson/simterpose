...
- Il y a donc des dup2 et des pipe qui sont faits, mais visiblement le
  ...
  fd.. 
** TODO Dans read faire la médiation quand c'est un pipe 
...
- J'ai rééssayé de tester allpairs: il y a un souci dans la manière
  ...
  - Dans le pipe on met un champ entrée et un champ sortie, qui
    ...
    tous les dupliqués)
** Resumé de l'état des tests:
- python pp: 
   - Je n'arrive pas à faire communiquer le processus avec le clone
     qu'il crée. Il y a des pipes et des dup2 d'impliqués, je les ai
     implémentés: j'ai des objets pipe pour me rappeler qui est le
     processus en face et sur quelle mailbox communiquer. Mais j'ai
     toujours des deadlocks, 
   - Il manquait la prise en compte du flag
     FD_CLOEXEC, pour fermer les descripteurs lors d'un exec. or
     maintenant tous les descripteurs sont fermés et donc je ne peux
     plus communiquer ..  
- allpairs: c'est le poll qui pose problème.
* <2014-07-29 mar.>
