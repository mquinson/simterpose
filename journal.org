...
** TODO gérer les flags de clone (notamment TID)
...
- le syscall fork n'a pas besoin d'être traité, c'est
  systématiquement clone qui est appelé à la place.
...
** TODO lire 'execve(2) under ptrace' dans man ptrace
