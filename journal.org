...
** TODO Il faudrait mettre le même genre de handler sur SIGSEGV
...
** TODO finir de modifier les sémaphores
** TODO ajouter les syscall manquants par rapport à la version SD
** TODO cas de full
...
- tenter de maintenir le meme ?
 ...
 - en fait le stream est nul dès la fin du connect pre, puisque le
    accept post est passé par là ! le sockfd entre autres a changé
    (donc si on garde le file descriptor il est bon, mais si on
    retourne récupérer les arguments dans sysarg, ce ne sont plus les
    bons)
