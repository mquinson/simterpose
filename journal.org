Ce document contient le journal de bord et les notes de travail relatives au
...
#+endverbatim
      ...
      - C'est à partir des 4(pipes-fcntl) suivis du clone que les traces
        divergent: dans simterpose il n'y a qu'un seul pipe-fcntl et
        après ça fait nimporte quoi.
    - en address translation ça deadlock, cf explications du vendredi
      1er août
  - allpairs:
...
- les deux méthodes (address/full) ne sont pas toujours
  respectées/correctes: cf explications du mercredi 6
- ajouter:
...
- faire d'autres tests:
  - durée de la simulation pour address translation/full mediation
** TODO compléter tests
- revoir la fermeture des processus en cas de crash: de temps en temps
  j'ai des "address already in use" quand SimTerpose a crashé (c'est
  un peu aléatoire comme comportement). Je pense que c'est parce que
  je ne quitte pas bien toutes les applications ou ne ferme pas bien
  les sockets 
