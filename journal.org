...
- Au lieu de faire des peek et des poke (Gabriel) :
  - Aller directement écrire dans la mémoire dans /proc/<pid>/mem
...
- Allpairs:
  - Il faut traiter le clone:
    ...
    - Dans le clone_pre je ne sais pas quoi restaurer comme valeur de
      ...
      aussi. Reregarder le strace (visiblement c'est soit le pid, soit pid+1)
    - C'est pas très clair mais: Admettons que je continue avec ce
      ...
      = 1 ou 0 au ps cloné .. 
** TODO regarder la section PTRACE_O_TRACECLONE dans le man de ptrace
** DONE renommer sans "_msg"
* <2014-07-11 ven.>
- j'ai renommé tous les fichiers sans le _msg
- appel clone: 
  - On obtient le pid du fils en faisant un PTRACE_GETEVENTMSG
  - Donner un nom, un hôte etc. au clone
  - Pour la liste de file descriptors, mettre stdin stdout stderr? 
