...
- J'ai modifié simgrid pour exporter les fonctionnalités de xbt_os_timer, dans
  ...
  - TODO: il faut refaire la même interface que xbt_os_timer, mais avec netlink
...
#+endverbatim
  - Il faut tout changer, mais ce n'est pas simple de modifier 700 lignes aussi
    ...
    - TODO: créer des syscall_XXX_pre, avec le traitement du premier switch, et
      changer le switch pour les utiliser
    - TODO: créer des syscall_XXX_post, avec le traitement du second switch
    ...
    - TODO pour chaque XXX, écrire syscall_XXX_pre juste avant syscall_XXX_post
      dans le fichier
  ...
  - TODO: ajouter un flag --strace à simterpose qui controle si les fonctions
...
- le module ptrace_utils, qui englobe de façon plus simple les fonctionnalités
  ...
  repris en main.
- TODO: est ce qu'on peut tuer le code dans MSG/ ?
...
* <2014-05-26 lun.>
- Chez moi si j'envoie suffisamment de messages ça part souvent en boucle infinie 
(50 suffit généralement à faire péter le truc)
- ok je tue MSG/
