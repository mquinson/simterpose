...
** TODO shutdown est mal traité en full mediation (renvoie -107)
** TODO Vérifier la cohérence des méthodes
En fait il y a sans doute un problème dans la méthode puisque les deux
donnent exactement le même temps.. Ou alors c'est parce que c'est le
temps simulé?
