...
- appel clone: 
  ...
  - En fait sur un essai ça a eu le temps de créer 4 clones avant de
    ...
    - TODO essayer de garder les clones en vie jusqu'à la fin pour
      être surs que le nouveau pid sera distinct .. 
  - Normalement dans le clone_post, on distingue le pere et le fils
    ...
    in ET en out -_-)
** TODO trouver un moyen de distinguer le pere du fils
  - J'arrive pas à comprendre à quoi correspondent les différents
    ...
    jamais .. 
** TODO regarder fork, puisque clone est un cas particulier de fork
