...
** TODO ajouter des refcounts pour comm_t 
...
- les tests avec allpairs et pp python ne fonctionnent pas 
  - python pp: 
    - en full mediation ça termine, il faut regarder si les traces
      sont correctes
    - en address translation, cf explications du vendredi 1er août
  - allpairs:
    - ça boucle avec des nanosleep
    - c'est parce que la connexion n'est pas établie
  - poll
- refcounts:
  - implementés pour fd et is mais il y a des erreurs. ne valent pas
    zéro à la fin. 
  - en rajouter pour comm_t
