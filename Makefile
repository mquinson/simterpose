...
all : simterpose simterpose_msg applications/client applications/server applications/client_msg applications/server_msg
...
#################################################
simterpose_msg: args_trace_msg.o communication_msg.o cputimer_msg.o data_utils_msg.o print_syscall_msg.o process_descriptor_msg.o ptrace_utils_msg.o simterpose_msg.o \
sockets_msg.o syscall_process_msg.o task_msg.o
	$(CC) $^ -o $@ $(LDFLAGS)
