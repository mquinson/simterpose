OBJS = args_trace.o syscalls_io.o calc_times_proc.o process_descriptor.o ptrace_utils.o sockets.o insert_trace.o run_trace.o benchmark.o syscall_process.o replay.o\
...
run_trace.o: run_trace.c run_trace.h insert_trace.h sysdep.h sockets.h syscalls_io.h calc_times_proc.h process_descriptor.h \
...
insert_trace.o: insert_trace.c insert_trace.h sysdep.h sockets.h syscalls_io.h calc_times_proc.h process_descriptor.h run_trace.h task.h
	$(CC) $(CFLAGS) -c $< -o $@
